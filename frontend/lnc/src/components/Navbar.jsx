...
const navigation = [
  ...
  { name: 'Appointments', href: '/appointments', auth: true },
  { name: 'Symptom Checker', href: '/symptom-checker', auth: true },
  { name: 'Nutrition', href: '/nutrition', auth: true },
];
            ...
            <div className="flex h-16 justify-between">
              <div className="flex">
                <div className="flex flex-shrink-0 items-center">
                  <Link to="/">
                    <span className="text-2xl font-bold text-indigo-600">LadeNutriCare</span>
                  </Link>
                </div>
